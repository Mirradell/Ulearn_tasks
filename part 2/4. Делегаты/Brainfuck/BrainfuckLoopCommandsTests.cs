...
..>+++++++++[<---------->-]<-----.---.+++.---.[-]<<<]");
			...
			Assert.IsTrue(text.Contains("99 Bottles of beer on the wall"), "1");
			Assert.IsTrue(text.Contains("Take one down and pass it around"), "2");
			Assert.IsTrue(text.Contains("43 Bottles of beer on the wall"), "3");
			Assert.IsTrue(text.Contains("1 Bottle of beer on the wall"), "4");
			Assert.IsTrue(text.Contains("0 Bottles of beer on the wall"), "5");
		}
